  ...
  return (
    <CustomerLayout>
      <div className="space-y-6">
          ...
          <div className="mx-18 lg:mx-30 xl:mx-30">
            ...
            <div className="text-justify">
              <p className="lg:text-xl xl:text-2xl text-gray-600 leading-relaxed">
                ...
                systems, water treatment chemical supplies, descaling and
                chemical cleaning of various industrial equipment such as Heat
                exchangers, Boilers, Cooling towers, Tanks, Boilers, Cooling
                towers, Chillers, Air-handling units, Condensers, Evaporators,
                Heat exchangers, Oil-coolers and also for Waste water treatment
                plant.
              </p>
            </div>
          </div>
        ...
        <section id="services" className="pt-0  py-16">
          <div className="mx-25">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-center mb-8 lg:mb-10 xl:mb-16 text-[#004785]">
