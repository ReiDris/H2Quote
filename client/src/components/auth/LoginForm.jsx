    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full text-white">
          ...
          <div className="text-center max-w">
            <h1 className="text-2xl lg:text-4xl xl:text-5xl leading-7 lg:leading-10 xl:leading-13 tracking-tight font-medium mb-4">
              Welcome to TRISHKAYE <br />ENTERPRISES
            </h1>
      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50 ">
        <div className="w-full max-w m-10 lg:m-15 xl:m-30">
            <div className="mb-8">
              <h2 className="text-2xl lg:text-3xl xl:text-4xl font-semibold text-[#004785] mb-2">Log in</h2>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-5 bg-gray-50 text-gray-500 text-md lg:text-lg xl:text-xl">OR</span>
              </div>
            </div>
