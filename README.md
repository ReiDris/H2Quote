...
- **request_statuses** - Request status definitions
- **services** - Available service catalog
- **chemicals** - Chemical products catalog
- **refrigerants** - Refrigerant products catalog

### Request Management
- **service_request_items** - Services in requests
- **service_request_chemicals** - Chemicals in requests
- **service_request_refrigerants** - Refrigerants in requests
...
- **message_replies** - Message thread replies
